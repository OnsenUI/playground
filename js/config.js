    ...
    app.config.lib = {
        remote: {
            js: {
                ...
                system: `https://cdnjs.cloudflare.com/ajax/libs/systemjs/0.19.36/system.js`,
                angular2: 'https://cdnjs.cloudflare.com/ajax/libs/angular.js/2.0.0-beta.17/angular2.js',
                angular2Onsenui: `${app.config.cdnURL[app.config.cdn]}/${app.config.repos[app.config.cdn].angular2Onsenui}${(app.config.versions.angular2Onsenui ? (app.config.vSep[app.config.cdn] + app.config.versions.angular2Onsenui) : '')}/dist/src/angular2-onsenui.js`,
